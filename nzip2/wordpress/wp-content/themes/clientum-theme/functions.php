...
/* ═══════════════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════════════ */
if ( ! defined( 'CLNTM_VERSION' ) ) define( 'CLNTM_VERSION', '2.1.0' );
if ( ! defined( 'CLNTM_DIR' ) )     define( 'CLNTM_DIR',     get_template_directory() . '/' );
if ( ! defined( 'CLNTM_URL' ) )     define( 'CLNTM_URL',     get_template_directory_uri() . '/' );
if ( ! defined( 'CLNTM_DB_VER' ) )  define( 'CLNTM_DB_VER',  '2' );
