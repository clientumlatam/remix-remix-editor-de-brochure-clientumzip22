...
namespace LearnPress\Prerequisite;

use LearnPress\Models\CourseModel;
use LearnPress\Models\UserItems\UserCourseModel;
use LearnPress\Models\UserModel;
use LP_Addon_Prerequisites_Courses;
use LP_Addon_Prerequisites_Courses_Preload;
use LP_Asset_Key;
use LP_Course;
use LP_Debug;
...
class PrerequisiteHook {
	...
	/**
	 * @return PrerequisiteHook
	 */
	public static function get_instance(): PrerequisiteHook {
