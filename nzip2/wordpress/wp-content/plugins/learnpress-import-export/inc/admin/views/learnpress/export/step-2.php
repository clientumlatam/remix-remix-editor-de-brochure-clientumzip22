...
<div id="export-step-2-options">
	...
	<p>
		<input class="regular-text"
			value="<?php echo esc_attr( LP_Export_LearnPress_Provider::get_export_file_name_without_extension() ); ?>" type="text"
	...
	<p>
		<button class="button button-primary" id="button-export"
				disabled="disabled"><?php _e( 'Export now', 'learnpress-import-export' ); ?>
		</button>
