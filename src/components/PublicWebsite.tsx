...
export default function PublicWebsite({
  ...
  // Full services catalog (457 servicios) — search, category filter & pagination
  ...
  const handleExportWooCommerceCSV = () => {
    ...
    const solucionesData = [
      ...
      { id: "catalogo",         name: "Catálogo Completo",   desc: "457 servicios en 15 categorías con precios reales." },
  ...
  const menuConfig = useMemo(() => [
    ...
    },
    {
      ...
      children: [
        ...
        { id: "catalogo", label: "Catálogo de Servicios", desc: "457 servicios en 15 categorías con precios", icon: LayoutGrid, color: "text-indigo-500 bg-indigo-50" },
                  ...
                  <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                      {[
                        ...
                        { id: "catalogo",       icon: LayoutGrid,   color: "bg-indigo-50 text-indigo-600 border-indigo-100",accent:"group-hover:text-indigo-600", label: "Catálogo Completo",     desc: "457 servicios en 15 categorías con precios reales." },
