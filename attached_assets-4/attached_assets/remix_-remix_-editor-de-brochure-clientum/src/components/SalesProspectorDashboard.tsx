...
export default function SalesProspectorDashboard({
  ...
  // Navigation tabs
  const [activeTab, setActiveTab] = useState<"pipeline" | "icp" | "research" | "meddic" | "outreach">("pipeline");
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-50 relative animate-fadeIn h-full">
      ...
      <div className="bg-slate-900 border-b border-slate-800 text-white px-6 py-4 flex items-center justify-between no-print z-10 shadow-md">
        ...
        {/* Top Control Tabs */}
        <div className="flex bg-slate-800/80 p-0.5 rounded-lg border border-slate-700 max-w-lg">
          <button
            onClick={() => setActiveTab("pipeline")}
            className={`px-3 py-1.5 rounded-md text-[11px] font-bold transition-all cursor-pointer flex items-center gap-1 ${
              activeTab === "pipeline" ? "bg-emerald-600 text-white shadow-md" : "text-slate-400 hover:text-white"
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-[11px] font-bold transition-all cursor-pointer flex items-center gap-1 ${
              activeTab === "icp" ? "bg-emerald-600 text-white shadow-md" : "text-slate-400 hover:text-white"
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-[11px] font-bold transition-all cursor-pointer flex items-center gap-1 ${
              activeTab === "research" ? "bg-emerald-600 text-white shadow-md" : "text-slate-400 hover:text-white"
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-[11px] font-bold transition-all cursor-pointer flex items-center gap-1 ${
              activeTab === "meddic" ? "bg-emerald-600 text-white shadow-md" : "text-slate-400 hover:text-white"
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-md text-[11px] font-bold transition-all cursor-pointer flex items-center gap-1 ${
              activeTab === "outreach" ? "bg-emerald-600 text-white shadow-md" : "text-slate-400 hover:text-white"
            }`}
          >
                  ...
                  <div className="xl:col-span-5 bg-white border border-slate-200 rounded-2xl shadow-xs overflow-hidden flex flex-col h-[480px] xl:h-[620px]">
                    ...
                    <div className="flex-1 relative bg-slate-100 flex flex-col items-center justify-center">
                      {(() => {
                        ...
                        // Render official Google Maps embed when API key is provided
                        if (customApiKey) {
                          const queryParam = encodeURIComponent(`${activeProspect.company}, ${activeProspect.address}, ${activeProspect.city}`);
                          const embedUrl = `https://www.google.com/maps/embed/v1/place?key=${customApiKey}&q=${queryParam}`;
                          return (
                            <iframe
                        ...
                        // Otherwise, fallback to a beautiful, highly detailed local interactive vector map component!
                        return (
