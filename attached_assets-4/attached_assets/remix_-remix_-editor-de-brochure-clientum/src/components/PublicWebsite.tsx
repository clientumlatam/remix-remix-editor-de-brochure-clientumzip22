...
export default function PublicWebsite({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-800 selection:bg-[#1A3461] selection:text-white relative">
      {/* Top Banner Warning & Editor Shortcut Toggle */}
      <div className="bg-[#0d1f3c] border-b border-[#122442] text-slate-300 text-xs px-6 py-2 flex items-center justify-between no-print z-50 shrink-0">
        <span className="flex items-center gap-2">
          <span className="inline-block w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></span>
          <span>Estás visualizando el <strong>Sitio Web Público de Clientum S.R.L.</strong></span>
        </span>
        <button
          onClick={onBackToEditor}
          className="bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-extrabold text-[10px] px-3 py-1 rounded-md uppercase tracking-wider flex items-center gap-1.5 transition-all cursor-pointer"
        >
          <ArrowLeftRight className="w-3 h-3" />
          Volver al Editor de Brochure
        </button>
      </div>
