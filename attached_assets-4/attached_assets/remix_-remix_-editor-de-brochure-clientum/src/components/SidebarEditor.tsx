...
import { Sliders, Edit3, Sparkles, RefreshCw, Send, CheckCircle2, AlertTriangle, Languages, Users, Github, Image, Eye, X, Check, Save, Trash2, FolderHeart, Plus } from "lucide-react";
...
export default function SidebarEditor({
  ...
  const [activeTab, setActiveTab] = useState<"config" | "pages" | "ai" | "crm">("config");
