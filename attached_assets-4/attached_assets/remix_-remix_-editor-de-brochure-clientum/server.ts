...
function getMockProspects(city: string, industry: string): any {
  ...
  const prospects = names.map((item, idx) => {
    ...
    const contacts = ["Ing. Marcos S.", "Laura G.", "Carlos M.", "Lic. Rodríguez", "Sofía Fernández"];
    const painPoints = [
...
Investiga, prioriza y encuentra 5 empresas u organizaciones locales verdaderas que aparezcan en Guía Cores o existan en "${city}" correspondientes con el rubro.
