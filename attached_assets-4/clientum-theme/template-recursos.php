...
<section class="section section--sm" style="background:var(--navy)">
  <div class="container text-center" style="max-width:600px">
    ...
    <form style="display:flex;gap:12px;max-width:460px;margin-inline:auto">
      <input type="email" placeholder="tu@email.com" class="form-input" style="flex:1" required>
      <button type="submit" class="btn btn-green">Suscribirme</button>
    </form>
